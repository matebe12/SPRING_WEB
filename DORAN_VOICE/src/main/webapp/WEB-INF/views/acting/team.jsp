...
<body>
	...
	<div class="container">
		...
		<c:if test="${pageMaker.prev}">
			...
			<a
				href='<c:url value="/team?page=${pageMaker.startPage - 1}"/>'>«</a>
		...
		<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }"
			...
			<a href='<c:url value="/team?page=${idx}"/>'
		...
		<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
			...
			<a href='<c:url value="/team?page=${pageMaker.endPage + 1}"/>'>
				» </a>
